...
package net.mcreator.dimensionmod.particle;
...
public class CryingPortalParticle extends DimensionModModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public CryingPortalParticle(DimensionModModElements instance) {
		super(instance, 2);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("crying_portal"));
	}
