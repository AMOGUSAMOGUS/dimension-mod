...
package net.mcreator.dimensionmod.entity;
...
public class BlazeKingEntity extends DimensionModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("blaze_king").setRegistryName("blaze_king");
	public BlazeKingEntity(DimensionModModElements instance) {
		super(instance, 34);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BlazeKingRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16737793, -16751002, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("blaze_king_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				BlazeKingLootProcedure.executeProcedure($_dependencies);
			}
		}

		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			BlazeSlingItem.shoot(this, target);
		}
