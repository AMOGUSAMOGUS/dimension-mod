...
public class FrozenSandMeltProcedure extends DimensionModModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		for (int index0 = 0; index0 < (int) ((SandMeltRedius)); index0++) {
			...
			if (((world.getBlockState(new BlockPos((int) (x + (Counter)), (int) y, (int) z))).getBlock() == FrozenSandBlock.block.getDefaultState()
					.getBlock())) {
				{
			...
			if (((world.getBlockState(new BlockPos((int) x, (int) (y + (Counter)), (int) z))).getBlock() == FrozenSandBlock.block.getDefaultState()
					.getBlock())) {
				{
			...
			if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) (z + (Counter))))).getBlock() == FrozenSandBlock.block.getDefaultState()
					.getBlock())) {
				{
