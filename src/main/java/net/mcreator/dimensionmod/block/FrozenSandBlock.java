...
import net.mcreator.dimensionmod.procedures.FrozenSandMeltProcedure;
...
public class FrozenSandBlock extends DimensionModModElements.ModElement {
	@ObjectHolder("dimension_mod:frozen_sand")
	public static final Block block = null;
	public FrozenSandBlock(DimensionModModElements instance) {
		super(instance, 30);
	}
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				{
					...
					FrozenSandMeltProcedure.executeProcedure($_dependencies);
				}
			} else {
			}
		}
